...
const ResetPasswordPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <Helmet>
        <title>Reset Password - Book Collection</title>
      ...
      <div className="max-w-md w-full space-y-8 bg-white rounded-2xl shadow-2xl p-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link
              to="/login"
              className="flex-1 px-4 py-3 bg-white border-2 border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-300 text-center"
            >
              Back to Login
            </Link>
          </div>
